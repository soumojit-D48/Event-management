...
import { UserCheck, Calendar, Search, ArrowRight, Camera, Users } from "lucide-react";
...
//   const navigate = (path) => console.log("Navigate to:", path);
  ...
  const handleScanAttendance = (eventId) => {
      ...
      <section className="container mx-auto px-4 py-12">
        ...
        <div className="mb-8">
          ...
          <p className="text-gray-600">
            Scan QR codes and track attendance for your events
          </p>
        </div>
        ...
        <div className="mb-6">
          <div className="relative">
            ...
            <input
              ...
              className="w-full pl-10 pr-4 py-3 border-2 border-gray-200 rounded-lg focus:border-blue-400 focus:outline-none transition"
            />
          </div>
        </div>
                    ...
                    return (
                      ...
                      >
                        ...
                        <td className="px-6 py-4 text-center">
                          <div className="inline-flex items-center gap-2 px-3 py-1 bg-indigo-100 text-indigo-700 rounded-full font-semibold">
                        ...
                        <td className="px-6 py-4 text-center">
                          <button
                            onClick={() => handleScanAttendance(event._id)}
                            className="inline-flex items-center gap-2 px-4 py-2 bg-gradient-to-r from-blue-600 to-indigo-600 hover:from-blue-700 hover:to-indigo-700 text-white rounded-lg transition font-medium"
                          >
              ...
              {filteredEvents.map((event) => {
                ...
                return (
                  <div key={event._id} className="p-4">
                    ...
                    <button
                      onClick={() => handleScanAttendance(event._id)}
                      className="w-full flex items-center justify-center gap-2 px-4 py-2 bg-gradient-to-r from-blue-600 to-indigo-600 hover:from-blue-700 hover:to-indigo-700 text-white rounded-lg transition font-medium"
                    >
                      <Camera className="h-4 w-4" />
                      Scan QR Code
                      <ArrowRight className="h-4 w-4" />
...
export default AttendanceScanOverview;